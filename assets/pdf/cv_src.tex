...
\begin{center}
  ...
  \\[4pt]
  \textit{Research Interests: Trustworthy multimodal AI, world models that truly understand physics, and AI alignment.}
\end{center}
...
\begin{itemize}
  \item \textbf{Honors:} SenseTime Scholarship; Yuanpei Young Scholar; Boya Scholarship; Soong Ching Ling Future Scholarship; Beijing Natural Science Foundation \textit{QiYan} Research Program; Freshman Scholarship (First Prize)
...
\pubentry{Debate with Images: Detecting Deceptive Behaviors in Multimodal LLMs}{\venue{ICML 2026}}{https://arxiv.org/abs/2512.00349}
...
\begin{itemize}
  \item World model startup building world foundation models that truly understand physics. Backed by Hillhouse Ventures and Yanyuan Capital (over \$10M first round).
\end{itemize}
...
\begin{itemize}
  ...
  \item Led the development of \textbf{Debate with Images} (ICML 2026), a visually grounded multi-agent debate framework for multimodal deception detection, along with \textbf{MM-DeceptionBench}, the first benchmark for multimodal deception.
...
2026 & SenseTime Scholarship \hfill {\small\textit{30 recipients nationwide}} \\
